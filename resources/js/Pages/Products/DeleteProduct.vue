...
<template>
    <button
        @click="openModal"
        class="cursor-pointer group inline-flex items-center gap-2 px-4 py-2.5 border border-red-200 rounded-xl text-sm font-medium text-red-600 bg-white hover:bg-red-50 hover:border-red-300 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-300 transition-all duration-200 shadow-sm hover:shadow"
        :disabled="isDeleting"
    >
        <svg
                        ...
                        <div class="mb-6">
                            ...
                            >
                                <p class="text-sm text-red-700">
                                    <strong>Warning:</strong> All associated
                                    data including batches, inventory records,
                                    and transaction history will be permanently
