...
const submit = () => {
    form.post(route("accounts.change-password"), {
        preserveScroll: true,
        onSuccess: () => {
            closeModal();
        },
                        ...
                        <form @submit.prevent="submit" class="space-y-4">
                            ...
                            <div class="flex gap-3 justify-end pt-4">
                                ...
                                <button
                                    type="submit"
                                    :disabled="form.processing"
                                    class="px-4 py-2.5 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 min-w-[120px] justify-center"
                                >
                                    <svg
